/*
    ...
    - objetivo 1 - quando clicar no botão de troca de tema, adicionar a classe modo-escuro no body pra que os estilos do modo escuro sejam aplicados e mudar a imagem pra logo-escura
        - passo 1 - pegar no JS o elemento HTML correspondente ao botão de troca de tema
        - passo 2 - dar um jeito de pegar no JS o elemento HTML corresponde ao body
        - passo 3 - dar um jeito de identificar o clique do usuário no botão de troca de tema
        - passo 4 - adicionar a classe modo-escuro no body
        - passo 5 - trocar a imagem do botão de alterar tema pra logo-escura
    ...
    - objetivo 2 - quando clicar no botão de troca de tema, caso o body já tenha a classe modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem pro sol
     ...
     - passo 8 - trocar a imagem do botão de alterar tema pra logo-claro
*/
...
botaoAlterarTema.addEventListener("click",() => {
 ...
 if(modoEscuroEstaAtivo){
     ...
     imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagem/logo-clara.jpg");
 } else { 
   imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagem/logo-escuro.jpg");
}
});